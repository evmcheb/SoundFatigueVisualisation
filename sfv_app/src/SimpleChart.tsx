...
export default class SimpleChart extends React.PureComponent<ISimpleChartProps, ISimpleChartState> {
  ...
  drawChart(){
    ...
    const size = 500
    const svg = d3.select(this.ref.current).append('svg').attr('width',
  ...
  render() {
    return (
      <div className="SimpleChart" ref={this.ref}/>
